...
export function PropertyMap() {
  ...
  const nearbyPlaces = [
    { name: "The Heritage Centre & Aerospace Museum", distance: "8.6 miles" },
    { name: "Commercial Street", distance: "12 miles" },
    { name: "Brigade Road", distance: "13 miles" },
    { name: "Chinnaswamy Stadium", distance: "13 miles" },
    { name: "Kempegowda International Airport", distance: "21 miles" },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="relative w-full h-full rounded-lg shadow-elegant overflow-hidden">
            ...
            {/* Overlay Info */}
            <div className="absolute top-4 left-4 right-4 bg-background/95 backdrop-blur-sm rounded-lg p-4 shadow-lg z-50">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-background rounded-lg shadow-elegant p-6 flex-1">
              ...
              <p className="text-muted-foreground mb-4 text-sm">
                Located in Bangalore, just 8.6 miles from The Heritage Centre & Aerospace Museum
                and 12 miles from Commercial Street.
              </p>
              <Button
                variant="outline"
                size="lg"
